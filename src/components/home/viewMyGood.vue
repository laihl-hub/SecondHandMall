  ...
  <div>
    <div class="address-box" v-for="(item, index) in goods" :key="index">
      ...
      <div class="address-content">
        <el-row>
          <el-col :span="6"><img src='static/img/珍珠奶茶.jpg' width="150px" height="150px"></el-col>
...
<!--        <p><span class="address-content-title">商品分类:</span> {{item.cname}}</p>-->
        ...
        <p><span class="address-content-title">简介:</span> {{item.pintro}}</p>
            <p><span class="address-content-title">发布时间:</span> {{convertTime(item.ptime,'YYYY-MM-DD HH:MM:SS')}}</p>
